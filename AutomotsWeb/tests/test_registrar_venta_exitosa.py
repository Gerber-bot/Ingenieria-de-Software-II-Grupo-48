...
class TestRegistrarVentaExitosa(unittest.TestCase):
    ...
    def test_registrar_venta_exitosa(
        self,
        ...
        self.assertEqual(resultado['id_venta'], 1)
        self.assertEqual(resultado['message'], 'Venta #1 registrada con éxito.')
